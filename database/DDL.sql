...
--
-- Date: 10/30/2025
-- Based on: Project Step 2 Draft: Normalized Schema + DDL with Sample Data (Group, on Ed Discussions)
-- Source URL: https://canvas.oregonstate.edu/courses/2017561/assignments/10111737?module_item_id=25645123
--
-- #############################
-- RESET Database
-- #############################
...
DELIMITER / / CREATE PROCEDURE sp_ResetDatabase () BEGIN
...
CREATE TABLE
  `Breaches` (
    ...
    CONSTRAINT `fk_Breaches_Megacorporations1` FOREIGN KEY (`Megacorporations_megacorp_id`) REFERENCES `Megacorporations` (`megacorp_id`) ON DELETE CASCADE ON UPDATE CASCADE
  );
...
CREATE TABLE
  `CyberAgents` (
    ...
    CONSTRAINT `fk_CyberAgents_Locations1` FOREIGN KEY (`Locations_location_id`) REFERENCES `Locations` (`location_id`) ON DELETE CASCADE ON UPDATE CASCADE
  );
...
CREATE TABLE
  `AssetsHasBreaches` (
    ...
    CONSTRAINT `AssetsHasBreaches_ibfk_1` FOREIGN KEY (`Assets_asset_id`) REFERENCES `Assets` (`asset_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `AssetsHasBreaches_ibfk_2` FOREIGN KEY (`Breaches_breach_id`) REFERENCES `Breaches` (`breach_id`) ON DELETE CASCADE ON UPDATE CASCADE
  );
...
CREATE TABLE
  `BreachesHasCyberAgents` (
    ...
    CONSTRAINT `BreachesHasCyberAgents_ibfk_1` FOREIGN KEY (`CyberAgents_agent_id`) REFERENCES `CyberAgents` (`agent_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `BreachesHasCyberAgents_ibfk_2` FOREIGN KEY (`Breaches_breach_id`) REFERENCES `Breaches` (`breach_id`) ON DELETE CASCADE ON UPDATE CASCADE
  );
...
CREATE TABLE
  `MegacorporationsHasLocations` (
    ...
    CONSTRAINT `MegacorporationsHasLocations_ibfk_1` FOREIGN KEY (`Megacorporations_megacorp_id`) REFERENCES `Megacorporations` (`megacorp_id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `MegacorporationsHasLocations_ibfk_2` FOREIGN KEY (`Locations_location_id`) REFERENCES `Locations` (`location_id`) ON DELETE CASCADE ON UPDATE CASCADE
  );
